import java.util.*;
/*
Return diameter of a BinaryTree.
Diameter of a BinaryTree is defined as the length of its longest peak, even if doesn't pass through the root of the tree.
*/
